...
<acme:list>
	...
	<acme:list-column code="assistant.tutorial-session.list.label.type" path="type" width="20%"/>
	<acme:list-column code="assistant.tutorial-session.list.label.initial-date" path="initialDate" width="20%"/>
</acme:list>

...
<acme:form>
	<acme:input-moment code="administrator.banner.form.label.initialDisplay" path="initialDisplay"/>
	<acme:input-moment code="administrator.banner.form.label.finalDisplay" path="finalDisplay"/>

...
<acme:form> 
	...
	<acme:input-select code="student.activities.form.label.aType" path="aType" choices="${activities}"/>
		<acme:input-select code="student.activities.form.label.enrolment" path="enrolment" choices="${enrolments}"/>	
	...
	<jstl:choose>	 
		...
		<jstl:when test="${_command == 'create'}">
			<acme:submit code="student.activities.form.button.create" action="/student/activity/create"/>
		</jstl:when>
	</jstl:choose>
</acme:form>
...
@Service
public class LecturerCourseDeleteServices extends AbstractService<Lecturer, Course> {
	...
	public void perform(final Course object) {
		...
		final Collection<CourseLecture> courseLectures = this.repository.findManyCourseLecturesByCourseId(object.getId());

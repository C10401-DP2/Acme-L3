...
public class LecturerCourseCreateTest extends TestHarness {
	...
	public void test100Postive(final int recordIndex, final String code, final String title, final String anAbstract, final String retailPrice, final String link) {
